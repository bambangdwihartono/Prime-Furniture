 ...
 <body>
	<div class="container kesalahan">
		<div class="row background-isi warna kesalahan_dalam">
			...
			<p class="text-center alert alert-danger">Data Yang Anda Masukan Salah</p>
			<center><a class="btn btn-primary" href="<?php echo base_url('primefurniture/testimoni'); ?>">Kembali</a></center>
		</div>
	</div>
</body>
</html>