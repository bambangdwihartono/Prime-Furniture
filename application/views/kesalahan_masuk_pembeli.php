 ...
 <body>
	<div class="container kesalahan">
		<div class="row background-isi warna kesalahan_dalam">
			...
			<p class="text-center alert alert-danger"><?php echo $this->session->flashdata('gagal_masuk_pembeli'); ?></p>
			<center><?php echo validation_errors(); ?></center>
			<center><a class="btn btn-primary" href="<?php echo base_url('primefurniture/pembeli'); ?>">Kembali</a></center>
		</div>
	</div>
</body>
</html>